    ...
    public void doIt(String[] args) {
        ...
        try {
            ...
            try {
                ...
                victory();
                printStats(timeStart, timeEnd, args, false, targetFile, myMetrics, learner, oracle, conceptNumber,
...
//		lastCE = null;
    ...
    private void precomputation(BaseEngine elQueryEngineForT, BaseEngine elQueryEngineForH) {
